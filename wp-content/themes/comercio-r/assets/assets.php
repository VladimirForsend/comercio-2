...
function comercio_framework()
{
    ...
    wp_enqueue_style('iconos', get_template_directory_uri() . '/assets/fafa/css/all.css', 'all');
    wp_enqueue_style('root', get_template_directory_uri() . '/assets/librerias/css/root.css', 'all');
    wp_enqueue_style('comercio-general-css', get_template_directory_uri() . '/assets/librerias/css/titan.css', 'all');
    wp_enqueue_style('comercio-ecommerce', get_template_directory_uri() . '/assets/librerias/css/ecommerce.css', 'all');
