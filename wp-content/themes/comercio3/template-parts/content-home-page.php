...
--->
    ...
    <!-- contador -->
        <!-- modulo-categorias-oferta -->
        <?php include get_template_directory() . '/assets/modulos/modulo-categorias-oferta/categorias-oferta-loop.php'; ?>
    <!-- fin modulo-categorias-oferta -->
    <!-- multibanners -->
