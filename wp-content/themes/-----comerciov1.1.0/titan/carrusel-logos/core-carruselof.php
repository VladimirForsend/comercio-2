...
function carrusel_logos() {
	...
	$labels = array(
		...
		'singular_name'         => _x( 'carrusel_oferta', 'Post Type Singular Name', 'carrusel_logos' ),
		...
		'add_new_item'          => __( 'Agregar nueva carrusel_oferta', 'carrusel_logos' ),
		'add_new'               => __( 'Agregar nueva', 'carrusel_logos' ),
		'new_item'              => __( 'nueva carrusel_oferta', 'carrusel_logos' ),
		'edit_item'             => __( 'editar carrusel_oferta', 'carrusel_logos' ),
		'update_item'           => __( 'actualizar', 'carrusel_logos' ),
		'view_item'             => __( 'Ver carrusel_oferta', 'carrusel_logos' ),
		'view_items'            => __( 'ver la carrusel_oferta', 'carrusel_logos' ),
		'search_items'          => __( 'buscar una carrusel_oferta', 'carrusel_logos' ),
...
function display_carrusel_logos( $carrusel_ofertaquery ) {
	if( is_category() || is_tag() && empty( $carrusel_ofertaquery->carrusel_ofertaquery_vars['carrusel_logosfilter'] ) ) {
