    ...
    <div class="container">
        <div class="row">
            ...
            <div id="campo_uno" class="col-12 col-sm-6 col-lg-3 campo_uno iconos_home">
				<a class="d-inline-block w-100" <?php $link1 = get_field('link_capsula_uno'); if(!empty($link1)){ ?> href="<?php the_field('link_capsula_uno'); ?>" <?php }; ?>>
            ...
            <div id="campo_dos" class="col-12 col-sm-6 col-lg-3 campo_dos iconos_home">
				<a class="d-inline-block w-100" <?php $link2 = get_field('link_capsula_dos'); if(!empty($link2)){ ?> href="<?php the_field('link_capsula_dos'); ?>" <?php }; ?>>
					<div class="contendor-iconos">
            ...
            <div id="campo_tres" class="col-12 col-sm-6 col-lg-3 campo_tres iconos_home">
				<a class="d-inline-block w-100" <?php $link3 = get_field('link_capsula_tres'); if(!empty($link3)){ ?> href="<?php the_field('link_capsula_tres'); ?>" <?php }; ?>>
					<div class="contendor-iconos">
            ...
            <div id="campo_cuatro" class="col-12 col-sm-6 col-lg-3 campo_cuatro iconos_home">
				<a class="d-inline-block w-100" <?php $link4 = get_field('link_capsula_cuatro'); if(!empty($link4)){ ?> href="<?php the_field('link_capsula_cuatro'); ?>" <?php }; ?>>
					<div class="contendor-iconos">
